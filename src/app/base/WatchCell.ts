...
import { correctIWatchJson, DayPart, getDayPartH, hrToTimeString } from '../utils/utils';
...
export class WatchCell {
  ...
  public setGuardId(grd: number) {
    ...
    this.isDirty = true;
    this.guardId = grd;
    this._Guard = Globals.getIGuard(this.guardId);
